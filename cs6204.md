...
| Lecture number | Topic| Additional readings|
|-------|--------|---------|
| 1| Introduction:  Overview of the Course, topic preview for Internet of Things, Energy challenge on IoT devices, Backscatter communication|
| 2|  |
| Research paper summary | 20%  |
| Project (Problem statement) | 20% |
| Project (Execution)(Final report/presentation) | 20% |
