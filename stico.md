# STICORS: Framework to support large-scale, ubiquitous, privacy-preserving, sticker-form, everlasting computers that are able to support long-range wireless capabilities 
