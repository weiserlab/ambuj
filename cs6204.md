...
**What to submit at the end of project?** Short video (upto 5 minutes long) describing the problem and results achieved. Also recommended (not graded) a poster describing the results. These will be shared among the sutdents in the course for peer-grading.
