...
**Deadline for project completion:** 3rd December 2022

**What to submit at the end of project?** Short video (upto 5 minutes long) describing the problem and results achieved. Please also prepare a poster describing these results. No other document (such as final report) needs to be submitted.

**Example of posters:** [Poster 1](https://github.com/weiserlab/ambuj/blob/main/ex1.pdf), [Poster 2](https://github.com/weiserlab/ambuj/blob/main/ex2.pdf), [Poster 3]()
