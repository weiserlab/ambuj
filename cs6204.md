...
This course covers the basics of IoT systems and some of the emerging applications. A major focus of this course is on wireless networking, one of the most critical functions of an IoT device. In the past two decades, wireless networking has also drawn significant research attention.  We will cover a wide range of topics in this course, including device architecture, wireless communication and standards, emerging wireless standards, sensing and actuation, and power management.  
## Approach
