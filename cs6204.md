...
Please submit a project description document. It should describe the problem, background work and existing approaches, timeline, equipment required for experiments, and brief outline for experiments that you have planned.

Deadline for completion of project: 3rd December 2022

*What to submit at the end of project?* Short video (upto 5 minutes long) describing the problem statement and results, you poster describing the results. These will be shared among the other sutdents in the course.
