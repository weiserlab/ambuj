...
We want to develop platform and framework to support a large number of wireless and everlasting sticker computers. They can perform complex computations, store data onboard (such as data captured from image sensor), and communicate information over long distances. STICORS is an interdisciplinary project requiring the convergence of several areas of engineering as well as it requires significant scientific breakthroughs.
